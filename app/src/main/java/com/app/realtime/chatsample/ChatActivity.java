...
import com.app.realtime.chatsample.adapter.ChatAdapter;
...
import com.app.realtime.chatsample.util.SessionManager;
...
import com.app.realtime.chatsample.xmpp.XmppCustomEventListener;
...
public class ChatActivity extends AppCompatActivity implements TextWatcher {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChatApplication.getmService().xmpp.getLastSeen(user2);
        //Setup our listView
